...
export default [
  {
    ...
    currency: '€',
    description:
      'A Palaeolithic site in the mountains about 45 minutes drive from Valencia. The roads can be tricky in larger in a van but it’s worth the ride. You’ll find a lovely quiet forest to camp in and various trails to explore. If you’re in to climbing there’s a fantastic rock face to climb too',
    parking: true,
    freeparking: true,
    toilets: false,
    water: false,
  ...
  },
  {
    ...
    currency: '€',
    description:
      'This beach is breathtaking! Parking on compacted sand about 20m from the beach.',
    parking: true,
    freeparking: true,
    toilets: false,
    water: false,
