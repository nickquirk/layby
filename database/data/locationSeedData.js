...
export default [
  ...
  },
  {
    ...
    currency: 'DH',
    description:
      'A small carpark about 10 minutes walk to the stunning blue city of Chefchaoen. 20DH per night stay. Camper service, toilet and water available.',
    parking: true,
    freeparking: false,
    toilets: true,
    water: true,
  ...
  },
  {
    ...
    currency: 'DH',
    description:
      'A huge area of land walking distance from the mountain city of Tafraoute. Walking routes to see the famous Blue Rocks. 20DH per night, camper service and water 15DH.',
    parking: true,
    freeparking: false,
    toilets: true,
    water: true,
